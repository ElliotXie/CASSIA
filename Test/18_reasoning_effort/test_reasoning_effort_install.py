"""
CASSIA Test 18: Reasoning Effort (PIP INSTALL MODE)
====================================================
...
Usage:
    python test_reasoning_effort_install.py
"""
...
def test_openrouter_reasoning_effort(output_dir, effort_level: str):
    ...
    try:
        ...
        runCASSIA_batch(
            ...
            max_workers=2,
            provider="openrouter",
            reasoning=effort_level,  # Simple string format
            validator_involvement="v1"
        )
...
def run_reasoning_effort_test():
    """Run all reasoning effort tests using pip-installed CASSIA."""
    print_test_header("18 - Reasoning Effort (PIP INSTALL MODE)")
    ...
    # Test 2: GPT-5.1 without reasoning
    print("\n" + "#"*70)
    ...
    # Test 4: Batch annotation with GPT-5.1
    print("\n" + "#"*70)
    ...
    # Summary
    print("\n" + "="*70)
    print("SUMMARY (PIP INSTALL MODE)")
    print("="*70)
    ...
    # Save metadata with pip install info
    metadata = create_test_metadata(
        test_name="reasoning_effort_comparison_install",
        config={
