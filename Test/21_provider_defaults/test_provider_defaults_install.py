"""
CASSIA Test 21: Provider Defaults (PIP INSTALL MODE)
=====================================================
...
def run_provider_defaults_test(results_dir):
    ...
    print_test_header("21 - Provider Defaults (PIP INSTALL MODE)")
...
def main():
    ...
    results_dir = create_results_dir("21_provider_defaults")
