# CASSIA Test 21: Provider Defaults (R) - INSTALL MODE
# =====================================================
...
run_provider_defaults_install_test <- function() {
  print_test_header("21 - Provider Defaults (R) [INSTALL MODE]")
  ...
  results_dirs <- create_results_dir("21_provider_defaults", get_test_mode())
