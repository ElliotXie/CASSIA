# CASSIA Test 09: Subclustering (R) - INSTALL MODE
# =================================================
...
#
# Usage:
#     Rscript test_subclustering_install.R
#
# Functions tested:
...
run_subclustering_install_test <- function() {
  print_test_header("09 - Subclustering (R) [INSTALL MODE]")
  ...
  results_dirs <- create_results_dir("09_subclustering", get_test_mode())
  ...
  tryCatch({
    ...
    output_name <- file.path(results_dirs$outputs, "subcluster_results")
  ...
  metadata <- create_test_metadata(
    test_name = "subclustering_install",
    config = config,
...
# Run test
success <- run_subclustering_install_test()
