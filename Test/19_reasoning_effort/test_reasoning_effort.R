# CASSIA Test 18: Reasoning Effort (R)
# =====================================
...
#
# Usage:
#     Rscript test_reasoning_effort.R
...
test_batch_annotation <- function(output_dir, model, provider, reasoning = NULL, test_name = "batch_test") {
  ...
  tryCatch({
    ...
    if (file.exists(summary_csv)) {
      ...
      log_msg("  Output file:", basename(summary_csv))
...
run_reasoning_effort_test <- function() {
  print_test_header("18 - Reasoning Effort (R)")
