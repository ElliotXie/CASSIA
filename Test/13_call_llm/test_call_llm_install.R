# CASSIA Test 13: call_llm Provider Testing (R) - INSTALL MODE
# =============================================================
...
#
# Usage:
#     Rscript test_call_llm_install.R
...
run_call_llm_install_test <- function() {
  print_test_header("13 - call_llm Provider Testing (R) [INSTALL MODE]")
  ...
  metadata <- create_test_metadata(
    test_name = "call_llm_provider_test_install",
    config = config,
...
# Run test
success <- run_call_llm_install_test()
