# CASSIA Test 03: Validator Comparison (R) - INSTALL MODE
# ========================================================
...
#
# Usage:
#     Rscript test_validator_comparison_install.R
...
run_validator_comparison_test <- function() {
  print_test_header("03 - Validator Comparison (R) [INSTALL MODE]")
  ...
  results_dirs <- create_results_dir("03_validator_comparison", get_test_mode())
  ...
  for (validator in validators) {
    ...
    output_name <- file.path(results_dirs$outputs, paste0("results_", validator))
  ...
  metadata <- create_test_metadata(
    test_name = "validator_comparison_install",
    config = config,
