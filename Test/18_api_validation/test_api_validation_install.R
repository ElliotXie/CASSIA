# CASSIA Test 18: API Key Validation Testing (R) - INSTALL MODE
# ==============================================================
...
#
# Usage:
#     Rscript test_api_validation_install.R
...
run_api_validation_test <- function() {
  print_test_header("18 - API Key Validation Testing (R) [INSTALL MODE]")
  ...
  metadata <- create_test_metadata(
    test_name = "api_validation_test_install_r",
    config = config,
