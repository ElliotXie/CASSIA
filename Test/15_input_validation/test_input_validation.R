# CASSIA Test 15: Input Validation (R)
# =====================================
...
#
# Usage:
#     Rscript test_input_validation.R
...
run_all_tests <- function() {
  print_test_header("15 - Input Validation (R)")
  ...
  results_dirs <- create_results_dir("15_input_validation", get_test_mode())
