# CASSIA Test 14: Customized Provider Testing (R) - INSTALL MODE
# ===============================================================
...
#
# Usage:
#     Rscript test_customized_provider_install.R
...
run_customized_provider_test <- function() {
  print_test_header("14 - Customized Provider Testing (R) [INSTALL MODE]")
  ...
  metadata <- create_test_metadata(
    test_name = "customized_provider_test_install_r",
    config = config,
