"""
CASSIA Test 14: Customized Provider Testing
============================================
...
Usage:
    python test_customized_provider.py
"""
...
def run_customized_provider_test():
    ...
    print_test_header("14 - Customized Provider Testing")
    ...
    metadata = create_test_metadata(
        test_name="customized_provider_test",
        config=config,
