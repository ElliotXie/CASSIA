# CASSIA Test 12: Batch Annotation with Reference (R) - INSTALL MODE
# ===================================================================
...
#
# Usage:
#     Rscript test_batch_with_reference_install.R
...
run_batch_with_reference_install_test <- function() {
  print_test_header("12 - Batch Annotation with Reference (R) [INSTALL MODE]")
  ...
  results_dirs <- create_results_dir("12_batch_with_reference", get_test_mode())
  ...
  tryCatch({
    ...
    output_name <- file.path(results_dirs$outputs, "batch_ref_results")
  ...
  metadata <- create_test_metadata(
    test_name = "batch_with_reference_install",
    config = config,
...
# Run test
success <- run_batch_with_reference_install_test()
