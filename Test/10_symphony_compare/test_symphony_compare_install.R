# CASSIA Test 10: Symphony Compare (R) - INSTALL MODE
# ====================================================
...
#
# Usage:
#     Rscript test_symphony_compare_install.R
#
# Functions tested:
...
run_symphony_compare_install_test <- function() {
  print_test_header("10 - Symphony Compare (R) [INSTALL MODE]")
  ...
  results_dirs <- create_results_dir("10_symphony_compare", get_test_mode())
  ...
  tryCatch({
    ...
    result <- CASSIA::symphonyCompare(
      ...
      model_preset = "budget",
      output_dir = results_dirs$outputs,
  ...
  metadata <- create_test_metadata(
    test_name = "symphony_compare_install",
    config = config,
...
# Run test
success <- run_symphony_compare_install_test()
