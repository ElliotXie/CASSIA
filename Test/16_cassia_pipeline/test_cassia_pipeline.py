"""
CASSIA Test 16: CASSIA Pipeline
================================
Tests the runCASSIA_pipeline function, the complete end-to-end cell type
annotation orchestrator.

Usage:
    python D:\CASSIA\Test\16_cassia_pipeline\test_cassia_pipeline.py
"""
...
def run_cassia_pipeline_test():
    ...
    print_test_header("16 - CASSIA Pipeline")
    ...
    results = create_results_dir("16_cassia_pipeline", get_test_mode())
    ...
    try:
        ...
        runCASSIA_pipeline(
            ...
            annotation_model=llm_config.get('model', 'google/gemini-3-flash-preview'),
            annotation_provider=llm_config.get('provider', 'openrouter'),
            score_model=llm_config.get('model', 'google/gemini-3-flash-preview'),
            score_provider=llm_config.get('provider', 'openrouter'),
            annotationboost_model=llm_config.get('model', 'google/gemini-3-flash-preview'),
            annotationboost_provider=llm_config.get('provider', 'openrouter'),
            score_threshold=99,
            merge_annotations=True,
            merge_model=llm_config.get('model', 'google/gemini-3-flash-preview'),
