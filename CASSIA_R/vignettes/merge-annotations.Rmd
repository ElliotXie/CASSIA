...
- `Cluster ID`: Column containing cluster IDs
- `Predicted General Cell Type`: General cell type annotations
- `Predicted Detailed Cell Type`: More detailed subtype annotations (can be comma-separated)
