...
\item[Description]\AsIs{CASSIA (Collaborative agent system for single-cell interpretable annotation) provides R wrappers for a Python-based single-cell annotator.
It uses reticulate to interface with the Python backend for cell type analysis and batch processing.}
