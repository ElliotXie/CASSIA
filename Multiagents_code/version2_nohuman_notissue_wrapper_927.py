...
def run_cell_type_analysis(model, temperature, marker_list, species, additional_info):
    ...
    def construct_prompt(json_data):
        ...
        prompt = f"I am analyzing a single-cell {species} dataset."
        if additional_info:
    ...
    4. Determine the most likely tissue type.                               
...
Verify the appropriateness of the annotation given the species and inferredtissue type.
