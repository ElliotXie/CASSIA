...
results = run_full_cell_type_analysis(
    "C:/Users/ellio/OneDrive - UW-Madison/cellgpt_final_folder/test_code/prostate_modified_markers_broad_cell_type_50genes.csv",
    output_json_name="prostate_results_broad2_debugging15_50_markers.json",
    model="gpt-4o",
    temperature=0,
    tissue="Prostate",
    species="human",
