...
This R Notebook demonstrates a complete workflow using CASSIA for cell type annotation of single-cell RNA sequencing data. We'll analyze an intestinal cell dataset containing six distinct populations:
...
install.packages("CASSIA_0.1.0.tar.gz", repos = NULL, type = "source")
