...
I will provide you with a list of markers ordered by their expression level from high to low from a cluster of cells
and your task is to identify the cell type.
You must think step-by-step, providing a comprehensive and specific analysis.
The audience is an expert in the field, and I will tip you $1000 if you do a good job.
...
When analysis completed, say "FINAL ANNOTATION COMPLETED"
If you receive feedback from the validation process, incorporate it into your analysis and provide an updated reasoning and annotation.
