...
export default function AnnotationBoostClient() {
    ...
    const loadClusters = async () => {
        ...
        try {
            const { getAvailableClusters } = await import('@/lib/cassia/annotationBoost');
    ...
    const extractConversation = async () => {
        ...
        try {
            const { extractConversationForCluster } = await import('@/lib/cassia/annotationBoost');
...
"GPM6B",0,7.23456789012345,0.892,0.023,0,"monocyte","GPM6B"`;
    ...
    const handleRunAnalysis = async () => {
        ...
        try {
            ...
            const { iterativeMarkerAnalysis, extractTopMarkerGenes, generateSummaryReport } = await import('@/lib/cassia/annotationBoost');
