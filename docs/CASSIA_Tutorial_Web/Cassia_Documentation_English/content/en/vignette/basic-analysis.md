...
results <- runCASSIA_pipeline(
    ...
    annotation_model = "gpt-4o", # Model for initial annotation
    annotation_provider = "openai",
    score_model = "claude-3-5-sonnet-20241022", # Model for quality scoring
    score_provider = "anthropic",
    score_threshold = 75, # Minimum score for high-quality annotations
    annotationboost_model = "claude-3-5-sonnet-20241022", # Model for annotation boost
