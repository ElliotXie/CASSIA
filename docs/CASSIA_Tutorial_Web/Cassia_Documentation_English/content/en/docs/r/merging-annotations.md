...
# Check results
print(result_df[, c("Cluster ID", "main_cell_type", "Merged_Grouping_1")])
```
...
print(result_df[, c("main_cell_type", "Merged_Grouping_1", "Merged_Grouping_2", "Merged_Grouping_3")])
```
...
- Parallel processing in `merge_annotations_all()` uses multiple workers by default.
