...
def generate_cluster_card(row: Dict[str, Any], index: int) -> str:
    ...
    """
    true_type = html.escape(str(row.get('True Cell Type', 'Unknown')))
    main_type = html.escape(str(row.get('Predicted Main Cell Type', 'Unknown')))
    sub_types = str(row.get('Predicted Sub Cell Types', ''))
